...
pacman -S filezilla cmus ranger terminus-font termite gvfs sudo engrampa calc flatpak git leafpad rofi flameshot transmission-cli go feh xorg-xinput --noconfirm
